...
// DecodeToGenericMap unmarshals a JSON blob into map[string]any.

// Returns a fully generic structure (maps, slices, primitives).
func DecodeToGenericMap(data []byte) (map[string]any, error) {
	var root any
...
var JsonObject = func() map[string]any {
...
func TestUsage1(t *testing.T) {
	fmt.Fprintln(os.Stdout,
		"Checking whether Packable can compact a map containing []any values, "+
